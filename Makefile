...
demo1-Linux-Debug:
	 $(PROJECTBUILD) demo1 Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

demo1-Linux-DebugGame:
	 $(PROJECTBUILD) demo1 Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

demo1-Linux-Shipping:
	 $(PROJECTBUILD) demo1 Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

demo1-Linux-Test:
	 $(PROJECTBUILD) demo1 Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

demo1:
	 $(PROJECTBUILD) demo1 Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

demo1Editor-Linux-Debug:
	 $(PROJECTBUILD) demo1Editor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

demo1Editor-Linux-DebugGame:
	 $(PROJECTBUILD) demo1Editor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

demo1Editor-Linux-Shipping:
	 $(PROJECTBUILD) demo1Editor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

demo1Editor-Linux-Test:
	 $(PROJECTBUILD) demo1Editor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

demo1Editor:
	 $(PROJECTBUILD) demo1Editor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
